      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">buildingAdmin</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="TeacherManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> Navigate: <a href="TeacherAdd.jsp">Add buildingAdmin</a></td>
                    <td width="72%">Search: 
                      <select name="SearchRow" id="SearchRow">
                        <option value="Teacher_Name">Name</option>
                        <option value="Teacher_Tel">Phone Number</option>
                        <option value="Teacher_Username">Username</option>
                      </select>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="TeacherUpdate.action?Teacher_ID=${Teacher_ID}">Modify</a> <a href="TeacherDel.action?Teacher_ID=${Teacher_ID}" onClick="return confirm('Sure to delete this buildingAdmin')">Delete</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
