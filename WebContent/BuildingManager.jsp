      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">Building admin</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="BuildingManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> Navigate: <a href="BuildingAdd.jsp">Add building</a></td>
                    <td width="72%">Name: 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <td bgcolor="#D5E4F4"><strong>Profile</strong></td>
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center">
                        <a href="TBManager.action?Building_ID=${Building_ID}">Admin</a> 
                        <a href="BuildingUpdate.action?Building_ID=${Building_ID}">Modify</a> 
                        <a href="BuildingDel.action?Building_ID=${Building_ID}" onClick="return confirm('Are you sure to delete this building? ')">Delete</a>
                      </td>
                    </tr>
                  </s:iterator>
                </table></td>
